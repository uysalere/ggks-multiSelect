    ...
    if(index < length) {
      ...
      for(i = index; i < length; i += offset) {
        ...
        */
        ...
        bucketIndex = (minPivotIndex * sharedNumSmallBuckets) + (int) ( ((double)num * sharedSlopes[minPivotIndex]) - ((double)sharedPivots[minPivotIndex] * sharedSlopes[minPivotIndex]) ) ;
